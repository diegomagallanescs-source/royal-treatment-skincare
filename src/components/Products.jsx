...
const allProducts = [
  ...
  { id: 21, brand: 'Hale Cosmeceuticals',  name: 'Stem Cell Renewal Serum',          category: 'Serums',             price: '$110', description: 'A cutting-edge anti-aging serum with plant stem cells and a peptide complex that stimulates renewal, firms, and visibly reduces deep wrinkles.', benefits: ['Plant stem cells', 'Peptide complex', 'Deep wrinkle reduction'] },
    ...
    <div className="products-page">
      ...
      <div className="products-hero">
        <div className="container">
          <button className="products-back" onClick={() => navigate('home')}>
            ← Back to Home
          </button>
          <span className="section-label">In-Studio Retail</span>
          <h1 className="products-page-title">Skincare Products</h1>
          <p className="products-page-subtitle">
            We carry four medical-grade professional brands — each formulated with higher concentrations
            of active ingredients than anything you'll find over the counter. Available exclusively in studio.
          </p>
      ...
      <div className="container">
        {filtered.length === 0 ? (
          <div className="products-empty">
            ...
            <button className="btn-outline" onClick={() => { setActiveCategory('All'); setActiveBrand('All Brands') }}>
              Clear Filters
            </button>
          </div>
        ) : (
